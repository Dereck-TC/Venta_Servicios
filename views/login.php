...
<section class="vh-100 gradient-custom">
          ...
          <div class="card-body p-5 text-center">
            ...
            <div class="mb-md-5 mt-md-4 pb-5">
              ...
              <div class="form-outline form-white mb-4">
                <input type="email" id="typeEmailX" class="form-control form-control-lg" placeholder="Correo Electronico" />
                <label class="form-label" for="typeEmailX"></label>
              </div>

              <div class="form-outline form-white mb-4">
                <input type="password" id="typePasswordX" class="form-control form-control-lg" placeholder="Clave"/>
 ...
 <div>
  <br>
              <p class="mb-0">&iquest; No tienes cuenta &iquest;  <a href="#!" class="text-white-50 fw-bold">Registrarme</a>
              </p>
            </div>
