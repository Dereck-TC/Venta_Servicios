...
<div class="hlt_header">
	...
	<div class="hlt_uprheader">
		<div class="hlt_uprleft">
			<ul>
				<li><p><span><i class="fa fa-calendar" aria-hidden="true"></i></span> 
					<?php
...
?>
				...
				<li><p><span><i class="fa fa-map-marker" aria-hidden="true"></i></span> Lima</p></li>
			</ul>
		</div>
	...
	<div class="hlt_lwrheader">
		<div class="hlt_uprleft">
			<ul>
				<li><p><span><i class="fa fa-ambulance" aria-hidden="true"></i></span> Asistencias terapeuticas las 24 horas Servicios: +(51) 999 999 999</p></li>
			</ul>
		</div>
				...
				<ul class="hs_menu collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				  ...
				  <li><a>Servicios</a>
					<ul>
					  ...
					  <li><a href="edicacional.php">Educacional</a></li>
